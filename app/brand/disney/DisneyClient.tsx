...
import FeaturedDisneyCollections from './FeaturedDisneyCollections';
import OriginalsDisneyCollections from './OriginalsDisneyCollections';
          ...
          <div className='bg-[rgb(26,29,41)] z-[3px] main-bg-pic'>
            <main className='relative block h-auto pb-8 overflow-x-hidden overflow-y-hidden '>
              <video
                ...
                src='https://vod-bgc-eu-west-1.media.dssott.com/bgui/ps01/disney/bgui/2021/11/04/1636056497-disney.mp4'
                autoPlay
                playsInline
                muted
              ...
              >
                <motion.img
                  ...
                  className='w-screen'
                  src='https://prod-ripcut-delivery.disney-plus.net/v1/variant/disney/61C377B14F25252D8A112D23A89A78516435DCF60F1C151854DE3D91C755A11A/scale?width=1440&aspectRatio=1.78&format=jpeg'
                  alt='Disney'
                  width={1536}
                  height={864}
                />
              ...
              <div>
                <FeaturedDisneyCollections />
                <div className='mb-[23px]' />
                <OriginalsDisneyCollections />
              </div>
            </main>
            <Footer />
          </div>

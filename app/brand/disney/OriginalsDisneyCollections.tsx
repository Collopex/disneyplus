...
import { originalsDisney } from '@/app/components/Collections/Collections';
...
const CustomNextArrow: React.FC<CustomArrowProps> = ({
  ...
  const isLastImage = currentSlide === 15;
  return (
    <button
...
const OriginalsDisneyCollections = () => {
    ...
    >
      ...
      <div>
        <Slider ref={sliderRef} {...settings}>
          {originalsDisney.map((item, index) => (
...
export default OriginalsDisneyCollections;

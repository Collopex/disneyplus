          ...
          <div className='bg-[rgb(26,29,41)] z-[3px] main-bg-pic'>
            <main className='relative block h-auto py-0 overflow-x-hidden overflow-y-hidden '>
              <video
                ...
                src='https://vod-bgc-eu-west-1.media.dssott.com/bgui/ps01/disney/bgui/2023/06/13/1686685609-marvel.mp4'
                autoPlay
                playsInline
                muted
              ...
              >
                <motion.img
                  ...
                  className='w-screen'
                  src='https://prod-ripcut-delivery.disney-plus.net/v1/variant/disney/62D6598A98D947B4418FA801AB7C7BC7789E7DD15D5F1378787D52A85B17D841/scale?width=1440&aspectRatio=1.78&format=jpeg'
                  alt='Marvel'
                  width={1536}
                  height={864}
                />
